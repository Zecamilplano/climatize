...
export function Header() {
  return (
    <header className="flex flex-row justify-between pl-8 pr-8 pt-1 shadow-header ">
      <img src={Logo} alt="Logo" width={300} />

      <div className="flex flex-col items-end pt-2 text-link-normal">
        <a href="https://wa.me/5577999827672?text=Ol%C3%A1%2C%20climatize!" className="text-flex">FONE: (77) 999827672</a>
        <nav>
