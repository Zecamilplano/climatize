...
export default function HomeComponent() {
  return (
    <section className=" bg-main flex gap-12 md:gap-7 flex-wrap justify-center items-center h-[100dvh]">
      ...
      <article className="bg-white self-center rounded-md flex justify-center items-center text-center flex-col w-[360px] h-[180px] gap-2 desktop-2560:w-[618px] desktop-2560:h-[290px] desktop-2560:gap-6">
        <ShoppingCart className="w-8 h-8 desktop-2560:w-16 desktop-2560:w-16" color={"#7283DB"} />
      ...
      <article className="bg-white self-center rounded-md flex justify-center items-center text-center flex-col w-[360px] h-[180px] gap-2 desktop-2560:w-[618px] desktop-2560:h-[290px] desktop-2560:gap-6">
        <Settings className="w-8 h-8 desktop-2560:w-16 desktop-2560:w-16" color={"#7283DB"} />
      ...
      <article className="bg-white self-center rounded-md flex justify-center items-center text-center flex-col w-[360px] h-[180px] gap-2 desktop-2560:w-[618px] desktop-2560:h-[290px] desktop-2560:gap-6">
        <House className="w-8 h-8 desktop-2560:w-16 desktop-2560:w-16" color={"#7283DB"} />
